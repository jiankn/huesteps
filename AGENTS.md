...
- Premium beauty-advertising appeal and mobile teaching clarity are hard release gates. Reject an ordinary stock-portrait or passport-photo impression, a dull or weakly styled model presentation, a face or target region that is too small at 360–430 px mobile widths, makeup that is not immediately readable, or a background that competes with the model or contaminates skin and makeup color. This applies across skin tones, ages, and face shapes and never permits celebrity copying or plastic skin.
- Crop and framing must follow the named teaching target. Identity, facial geometry, lens perspective, lighting, exposure, white balance, retouching strength, and background world remain locked, but a brow, eye, lash, cheek, or lip step must use a controlled close-up or responsive detail crop instead of preserving a distant full-face composition that hides the result.
